<?php
// Formidable Forms integration for Just Cloudflare Turnstile
...
class FormidableForms {
    ...
    public static function validate_turnstile($errors, $values, $form_id) {
        if (!self::is_valid_submission()) {
            $errors['form'] = self::get_error_message();
        }
        return $errors;
    }
    ...
    private static function get_error_message() {
        ...
        $message = apply_filters('jct_formidableforms_turnstile_error_message', $message);
